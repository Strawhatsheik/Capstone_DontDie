...
public String name = "";
//These re values to keep track of the players status. Theystart as true because the player starts
//whole and healthy
public Boolean arm = true, leg = true, eye = true, compass = false, rope = false;
//The players x and y co-ordinates for mving him on board
